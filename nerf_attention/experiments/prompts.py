...
CONVERSATIONAL = (
    ...
    "Assistant: At 2048 tokens, SIREN is about 80x slower than a theoretical HBM read "
    "on RTX 4060. The gap narrows at longer sequences but never crosses over at "
    "practical lengths.\n\n"
    "User: So not practical yet?\n\n"
    "Assistant: Not at any foreseeable sequence length. The analytical crossover is at "
    "hundreds of billions of tokens — effectively never. The structure analysis "
